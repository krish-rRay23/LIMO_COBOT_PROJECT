...
static rosidl_typesupport_introspection_c__MessageMember BoundingBox3D__rosidl_typesupport_introspection_c__BoundingBox3D_message_member_array[3] = {
  {
    ...
    offsetof(yolo_msgs__msg__BoundingBox3D, center),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yolo_msgs__msg__BoundingBox3D, size),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yolo_msgs__msg__BoundingBox3D, frame_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers BoundingBox3D__rosidl_typesupport_introspection_c__BoundingBox3D_message_members = {
  ...
  3,  // number of fields
  sizeof(yolo_msgs__msg__BoundingBox3D),
