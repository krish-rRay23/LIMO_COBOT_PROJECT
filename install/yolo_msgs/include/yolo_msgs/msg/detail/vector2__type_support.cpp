...
{
  new (message_memory) yolo_msgs::msg::Vector2(_init);
}

void Vector2_fini_function(void * message_memory)
{
  auto typed_message = static_cast<yolo_msgs::msg::Vector2 *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Vector2_message_member_array[2] = {
  {
    ...
    offsetof(yolo_msgs::msg::Vector2, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yolo_msgs::msg::Vector2, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<yolo_msgs::msg::Vector2>()
{
  return &::yolo_msgs::msg::rosidl_typesupport_introspection_cpp::Vector2_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yolo_msgs, msg, Vector2)() {
  return &::yolo_msgs::msg::rosidl_typesupport_introspection_cpp::Vector2_message_type_support_handle;
}
