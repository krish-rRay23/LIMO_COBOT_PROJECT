...
class KeyPoint2DArray(metaclass=Metaclass_KeyPoint2DArray):
    ...
    _fields_and_field_types = {
        'data': 'sequence<yolo_msgs/KeyPoint2D>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['yolo_msgs', 'msg'], 'KeyPoint2D')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'data' field must be a set or sequence and each value of type 'KeyPoint2D'"
        self._data = value
