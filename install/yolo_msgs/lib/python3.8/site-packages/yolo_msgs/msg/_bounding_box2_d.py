...
class Metaclass_BoundingBox2D(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from yolo_msgs.msg import Vector2
...
class BoundingBox2D(metaclass=Metaclass_BoundingBox2D):
    ...
    _fields_and_field_types = {
        'center': 'yolo_msgs/Pose2D',
        'size': 'yolo_msgs/Vector2',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['yolo_msgs', 'msg'], 'Pose2D'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['yolo_msgs', 'msg'], 'Vector2'),  # noqa: E501
    )
