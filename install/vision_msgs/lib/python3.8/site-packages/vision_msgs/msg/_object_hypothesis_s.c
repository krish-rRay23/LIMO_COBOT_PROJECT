...
bool vision_msgs__msg__object_hypothesis__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vision_msgs.msg._object_hypothesis.ObjectHypothesis", full_classname_dest, 51) == 0);
  }
  vision_msgs__msg__ObjectHypothesis * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of ObjectHypothesis */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vision_msgs.msg._object_hypothesis");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObjectHypothesis");
