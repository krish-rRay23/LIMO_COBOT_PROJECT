...
bool vision_msgs__msg__detection3_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vision_msgs.msg._detection3_d.Detection3D", full_classname_dest, 41) == 0);
  }
  vision_msgs__msg__Detection3D * ros_message = _ros_message;
  {  // header
  ...
  {  // bbox
    ...
    if (!vision_msgs__msg__bounding_box3_d__convert_from_py(field, &ros_message->bbox)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // source_cloud
    PyObject * field = PyObject_GetAttrString(_pymsg, "source_cloud");
    if (!field) {
      return false;
    }
    if (!sensor_msgs__msg__point_cloud2__convert_from_py(field, &ros_message->source_cloud)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * vision_msgs__msg__detection3_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vision_msgs.msg._detection3_d");
  ...
  {  // bbox
    PyObject * field = NULL;
    field = vision_msgs__msg__bounding_box3_d__convert_to_py(&ros_message->bbox);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // source_cloud
    PyObject * field = NULL;
    field = sensor_msgs__msg__point_cloud2__convert_to_py(&ros_message->source_cloud);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "source_cloud", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
