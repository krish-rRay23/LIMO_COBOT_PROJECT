...
bool vision_msgs__msg__detection2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vision_msgs.msg._detection2_d.Detection2D", full_classname_dest, 41) == 0);
  }
  vision_msgs__msg__Detection2D * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of Detection2D */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vision_msgs.msg._detection2_d");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Detection2D");
