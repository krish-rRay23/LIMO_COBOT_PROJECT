...
bool vision_msgs__msg__object_hypothesis_with_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vision_msgs.msg._object_hypothesis_with_pose.ObjectHypothesisWithPose", full_classname_dest, 69) == 0);
  }
  vision_msgs__msg__ObjectHypothesisWithPose * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of ObjectHypothesisWithPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vision_msgs.msg._object_hypothesis_with_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObjectHypothesisWithPose");
