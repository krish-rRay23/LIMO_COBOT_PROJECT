...
struct Classification3D_
{
  ...
  _header_type header;
  using _results_type =
    std::vector<vision_msgs::msg::ObjectHypothesis_<ContainerAllocator>, typename ContainerAllocator::template rebind<vision_msgs::msg::ObjectHypothesis_<ContainerAllocator>>::other>;
  ...
  Type & set__results(
    const std::vector<vision_msgs::msg::ObjectHypothesis_<ContainerAllocator>, typename ContainerAllocator::template rebind<vision_msgs::msg::ObjectHypothesis_<ContainerAllocator>>::other> & _arg)
  {
    this->results = _arg;
    return *this;
  }
