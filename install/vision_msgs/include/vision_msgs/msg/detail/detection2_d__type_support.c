...
void Detection2D__rosidl_typesupport_introspection_c__Detection2D_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  vision_msgs__msg__Detection2D__init(message_memory);
}

void Detection2D__rosidl_typesupport_introspection_c__Detection2D_fini_function(void * message_memory)
{
  vision_msgs__msg__Detection2D__fini(message_memory);
}

size_t Detection2D__rosidl_typesupport_introspection_c__size_function__ObjectHypothesisWithPose__results(
...
const void * Detection2D__rosidl_typesupport_introspection_c__get_const_function__ObjectHypothesisWithPose__results(
...
void * Detection2D__rosidl_typesupport_introspection_c__get_function__ObjectHypothesisWithPose__results(
...
bool Detection2D__rosidl_typesupport_introspection_c__resize_function__ObjectHypothesisWithPose__results(
...
static rosidl_typesupport_introspection_c__MessageMember Detection2D__rosidl_typesupport_introspection_c__Detection2D_message_member_array[6] = {
  {
    ...
    offsetof(vision_msgs__msg__Detection2D, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vision_msgs__msg__Detection2D, results),  // bytes offset in struct
    NULL,  // default value
    Detection2D__rosidl_typesupport_introspection_c__size_function__ObjectHypothesisWithPose__results,  // size() function pointer
    Detection2D__rosidl_typesupport_introspection_c__get_const_function__ObjectHypothesisWithPose__results,  // get_const(index) function pointer
    Detection2D__rosidl_typesupport_introspection_c__get_function__ObjectHypothesisWithPose__results,  // get(index) function pointer
    Detection2D__rosidl_typesupport_introspection_c__resize_function__ObjectHypothesisWithPose__results  // resize(index) function pointer
  },
  {
    "bbox",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vision_msgs__msg__Detection2D, bbox),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vision_msgs__msg__Detection2D, source_img),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vision_msgs__msg__Detection2D, is_tracking),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vision_msgs__msg__Detection2D, tracking_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Detection2D__rosidl_typesupport_introspection_c__Detection2D_message_members = {
  ...
  6,  // number of fields
  sizeof(vision_msgs__msg__Detection2D),
  Detection2D__rosidl_typesupport_introspection_c__Detection2D_message_member_array,  // message members
  Detection2D__rosidl_typesupport_introspection_c__Detection2D_init_function,  // function to initialize message memory (memory has to be allocated)
  Detection2D__rosidl_typesupport_introspection_c__Detection2D_fini_function  // function to terminate message instance (will not free memory)
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vision_msgs, msg, Detection2D)() {
  ...
  Detection2D__rosidl_typesupport_introspection_c__Detection2D_message_member_array[1].members_ =
  ...
  Detection2D__rosidl_typesupport_introspection_c__Detection2D_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vision_msgs, msg, BoundingBox2D)();
  Detection2D__rosidl_typesupport_introspection_c__Detection2D_message_member_array[3].members_ =
