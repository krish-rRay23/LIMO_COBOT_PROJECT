...
#include "yolo_msgs/msg/detail/key_point2_d__rosidl_typesupport_fastrtps_c.h"
...
#include "yolo_msgs/msg/detail/point2_d__functions.h"  // point
...
using _KeyPoint2D__ros_msg_type = yolo_msgs__msg__KeyPoint2D;
...
static uint32_t _KeyPoint2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yolo_msgs__msg__KeyPoint2D(
...
{
  return max_serialized_size_yolo_msgs__msg__KeyPoint2D(
    full_bounded, 0);
}
