...
#include "yolo_msgs/msg/detail/key_point3_d_array__rosidl_typesupport_fastrtps_c.h"
...
#include "yolo_msgs/msg/detail/key_point3_d__functions.h"  // data

// forward declare type support functions
size_t get_serialized_size_yolo_msgs__msg__KeyPoint3D(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_yolo_msgs__msg__KeyPoint3D(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yolo_msgs, msg, KeyPoint3D)();


using _KeyPoint3DArray__ros_msg_type = yolo_msgs__msg__KeyPoint3DArray;
  ...
  // Field name: data
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, yolo_msgs, msg, KeyPoint3D
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: data
  {
    ...
    if (ros_message->data.data) {
      yolo_msgs__msg__KeyPoint3D__Sequence__fini(&ros_message->data);
    }
    if (!yolo_msgs__msg__KeyPoint3D__Sequence__init(&ros_message->data, size)) {
  ...
  size_t current_alignment)
{
  ...
  // field.name data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_yolo_msgs__msg__KeyPoint3D(
...
static uint32_t _KeyPoint3DArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yolo_msgs__msg__KeyPoint3DArray(
  ...
  size_t current_alignment)
{
  ...
  // member: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_yolo_msgs__msg__KeyPoint3D(
...
{
  return max_serialized_size_yolo_msgs__msg__KeyPoint3DArray(
    full_bounded, 0);
}
