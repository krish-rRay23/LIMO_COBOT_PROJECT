...
#include "yolo_msgs/msg/detail/point2_d__rosidl_typesupport_fastrtps_c.h"
...
using _Point2D__ros_msg_type = yolo_msgs__msg__Point2D;
...
static uint32_t _Point2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yolo_msgs__msg__Point2D(
...
static size_t _Point2D__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_yolo_msgs__msg__Point2D(
    full_bounded, 0);
}
