...
{
  new (message_memory) yolo_msgs::msg::BoundingBox2D(_init);
}

void BoundingBox2D_fini_function(void * message_memory)
{
  auto typed_message = static_cast<yolo_msgs::msg::BoundingBox2D *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BoundingBox2D_message_member_array[2] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<yolo_msgs::msg::Pose2D>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(yolo_msgs::msg::BoundingBox2D, center),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<yolo_msgs::msg::Vector2>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(yolo_msgs::msg::BoundingBox2D, size),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BoundingBox2D_message_members = {
  ...
  2,  // number of fields
  sizeof(yolo_msgs::msg::BoundingBox2D),
...
{
  return &::yolo_msgs::msg::rosidl_typesupport_introspection_cpp::BoundingBox2D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yolo_msgs, msg, BoundingBox2D)() {
  return &::yolo_msgs::msg::rosidl_typesupport_introspection_cpp::BoundingBox2D_message_type_support_handle;
}
