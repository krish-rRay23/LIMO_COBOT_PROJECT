...
#include "yolo_msgs/msg/detail/point2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const yolo_msgs::msg::Point2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolo_msgs::msg::Point2D *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Point2D(full_bounded, 0);
}
...
{
  return &yolo_msgs::msg::typesupport_fastrtps_cpp::_Point2D__handle;
}
