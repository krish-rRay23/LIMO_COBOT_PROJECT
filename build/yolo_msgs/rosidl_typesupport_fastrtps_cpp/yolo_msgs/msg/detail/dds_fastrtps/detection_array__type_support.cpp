...
#include "yolo_msgs/msg/detail/detection_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yolo_msgs::msg::DetectionArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yolo_msgs::msg::DetectionArray & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        yolo_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Detection(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const yolo_msgs::msg::DetectionArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolo_msgs::msg::DetectionArray *>(
    untyped_ros_message);
...
{
  return &yolo_msgs::msg::typesupport_fastrtps_cpp::_DetectionArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolo_msgs, msg, DetectionArray)() {
  return &yolo_msgs::msg::typesupport_fastrtps_cpp::_DetectionArray__handle;
}
