...
#include "yolo_msgs/msg/detail/key_point3_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yolo_msgs::msg::KeyPoint3D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yolo_msgs::msg::KeyPoint3D & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
...
{
  auto typed_message =
    static_cast<const yolo_msgs::msg::KeyPoint3D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolo_msgs::msg::KeyPoint3D *>(
    untyped_ros_message);
...
{
  return &yolo_msgs::msg::typesupport_fastrtps_cpp::_KeyPoint3D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolo_msgs, msg, KeyPoint3D)() {
  return &yolo_msgs::msg::typesupport_fastrtps_cpp::_KeyPoint3D__handle;
}
