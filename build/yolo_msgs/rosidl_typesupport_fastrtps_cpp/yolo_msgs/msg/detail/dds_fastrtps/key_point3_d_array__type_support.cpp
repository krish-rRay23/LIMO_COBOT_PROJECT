...
#include "yolo_msgs/msg/detail/key_point3_d_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const yolo_msgs::msg::KeyPoint3D &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  yolo_msgs::msg::KeyPoint3D &);
...
cdr_serialize(
  const yolo_msgs::msg::KeyPoint3DArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yolo_msgs::msg::KeyPoint3DArray & ros_message)
{
  // Member: data
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        yolo_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_KeyPoint3D(
...
{
  auto typed_message =
    static_cast<const yolo_msgs::msg::KeyPoint3DArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolo_msgs::msg::KeyPoint3DArray *>(
    untyped_ros_message);
...
{
  return max_serialized_size_KeyPoint3DArray(full_bounded, 0);
}
...
{
  return &yolo_msgs::msg::typesupport_fastrtps_cpp::_KeyPoint3DArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolo_msgs, msg, KeyPoint3DArray)() {
  return &yolo_msgs::msg::typesupport_fastrtps_cpp::_KeyPoint3DArray__handle;
}
