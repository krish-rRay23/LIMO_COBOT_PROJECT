...
#include "yolo_msgs/msg/detail/detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const yolo_msgs::msg::BoundingBox2D &,
...
{
bool cdr_serialize(
  const yolo_msgs::msg::BoundingBox3D &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const yolo_msgs::msg::KeyPoint2DArray &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  yolo_msgs::msg::KeyPoint2DArray &);
size_t get_serialized_size(
  const yolo_msgs::msg::KeyPoint2DArray &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const yolo_msgs::msg::KeyPoint3DArray &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const yolo_msgs::msg::Detection & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.id;
  // Member: bbox
  yolo_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.bbox,
    cdr);
  // Member: bbox3d
  yolo_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yolo_msgs::msg::Detection & ros_message)
{
  // Member: class_id
  cdr >> ros_message.class_id;
  ...
  // Member: bbox
  yolo_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    yolo_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: bbox
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        yolo_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_BoundingBox2D(
  ...
  // Member: bbox3d
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        yolo_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_BoundingBox3D(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: mask
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        yolo_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Mask(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: keypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        yolo_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_KeyPoint2DArray(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: keypoints3d
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        yolo_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_KeyPoint3DArray(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const yolo_msgs::msg::Detection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolo_msgs::msg::Detection *>(
    untyped_ros_message);
...
{
  return &yolo_msgs::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolo_msgs, msg, Detection)() {
  return &yolo_msgs::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
