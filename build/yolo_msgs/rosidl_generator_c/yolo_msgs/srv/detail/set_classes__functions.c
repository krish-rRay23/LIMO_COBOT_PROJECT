  ...
  yolo_msgs__srv__SetClasses_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    yolo_msgs__srv__SetClasses_Request * data =
      (yolo_msgs__srv__SetClasses_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!yolo_msgs__srv__SetClasses_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          yolo_msgs__srv__SetClasses_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  yolo_msgs__srv__SetClasses_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    yolo_msgs__srv__SetClasses_Response * data =
      (yolo_msgs__srv__SetClasses_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!yolo_msgs__srv__SetClasses_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          yolo_msgs__srv__SetClasses_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
